...
class QuranService {
  ...
  Future<DailyVerseModel> getDailyVerse() async {
    ...
    final arabicUrl = '${ApiConstants.quranBaseUrl}${ApiConstants.randomVerseEndpoint}/$verseNumber';
    final translationUrl = '${ApiConstants.quranBaseUrl}${ApiConstants.randomVerseEndpoint}/$verseNumber/en.asad';
